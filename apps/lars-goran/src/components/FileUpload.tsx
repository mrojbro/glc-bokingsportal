...
const ACCEPTED = new Set(['csv', 'xlsx', 'xls', 'htm', 'html'])
  ...
  return (
    ...
    >
      <input
        ref={inputRef}
        type="file"
        accept=".csv,.xlsx,.xls,.htm,.html,text/csv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        className="hidden"
